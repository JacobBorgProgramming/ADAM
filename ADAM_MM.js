...
//chad
var templates_chad = Array('./memetemplates/djtmugshot.jpg', './memetemplates/gigachad1.jpg','./memetemplates/chadbateman.png','./memetemplates/patphone.png','./memetemplates/patsmile.jpeg','./memetemplates/stillerbased.jpeg','./memetemplates/basedpat.jpeg','./memetemplates/patmusic.jpeg','./memetemplates/benglow.jpeg')
...
var templates_goth = Array('./memetemplates/burnskeleton.jpeg','./memetemplates/spookyskeleton2.jpg','./memetemplates/whatsthisjack2.jpg','./memetemplates/spookyskeleton.jpg','./memetemplates/edward.jpg','./memetemplates/whatsthis.jpg','./memetemplates/wednesdaycomp.jpg','./memetemplates/gomez.jpg')
...
function conspiracyt(){
    var template_c = templates_c[Math.floor(Math.random()*templates_c.length)];

    document.getElementById("memebg").src = template_c
}

function chadt(){
    var template_chad = templates_chad[Math.floor(Math.random()*templates_chad.length)];

    document.getElementById("memebg").src = template_chad
}

function braint(){
    var template_brain = templates_bigbrain[Math.floor(Math.random()*templates_bigbrain.length)];

    document.getElementById("memebg").src = template_brain
}
...
function animalt(){
    ...
    document.getElementById("memebg").src = template_animal
}
